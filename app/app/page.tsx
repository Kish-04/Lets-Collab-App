...
import { Monitor, Gamepad2, LayoutDashboard, ArrowRight, User, Lock, Mail, ShieldAlert, Activity, Sparkles, Network, Download, Eye, EyeOff, Github } from "lucide-react"
                  ...
                  <>
                    ...
                    {(authMode === 'login' || authMode === 'register') && (
                      <div className="relative group">
                        ...
                        className="w-full bg-[rgba(var(--surface-rgb),0.5)] border border-[var(--border)] text-[var(--text-primary)] font-medium rounded-[var(--app-radius)] pl-12 pr-12 py-4 focus:border-[var(--accent)] outline-none transition-all focus:bg-[rgba(var(--surface-rgb),0.8)]"
                      />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
                          className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--text-dim)] hover:text-[var(--text-primary)] transition-colors"
                        >
                    ...
                    {authMode === 'reset' && (
                      <div className="relative group">
                        ...
                        <input
                          ...
                          value={formData.password}
                          onChange={e => setFormData({ ...formData, password: e.target.value })}
                          className="w-full bg-[var(--bg)]/50 border border-[var(--border)] text-[var(--text-primary)] font-medium rounded-xl pl-12 pr-12 py-4 focus:border-[var(--accent)] outline-none transition-all focus:bg-[var(--elevated)]"
                        />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
              ...
              {(authMode === 'login' || authMode === 'register') && (
                <div className="mt-6">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-xs font-medium text-[var(--text-dim)] uppercase tracking-widest">Or continue with</span>
                    <div className="flex-1 h-px bg-[var(--border)]" />
                  </div>
                  <div className="flex gap-4">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border border-[var(--border)] bg-[rgba(var(--surface-rgb),0.5)] hover:bg-[rgba(var(--surface-rgb),0.8)] hover:border-[var(--accent)] transition-all"
                    >
                      ...
                      <span className="text-sm font-bold text-[var(--text-primary)]">Google</span>
                    </button>
                    <button
                      type="button"
                      onClick={() => window.location.href = `${getBackendUrl()}/api/auth/github`}
                      className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border border-[var(--border)] bg-[rgba(var(--surface-rgb),0.5)] hover:bg-[rgba(var(--surface-rgb),0.8)] hover:border-[var(--accent)] transition-all"
                    >
