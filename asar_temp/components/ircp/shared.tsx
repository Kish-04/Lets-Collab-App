...
export function AppLogo({ 
  ...
  const sizeStyles = {
    small: { icon: 32, iconSize: 18, title: "text-xl", subtitle: "text-[8px]" },
    default: { icon: 56, iconSize: 28, title: "text-4xl", subtitle: "text-[11px]" },
    large: { icon: 72, iconSize: 36, title: "text-5xl", subtitle: "text-xs" }
  }
  ...
  return (
    <div className={cn("flex flex-col items-center gap-2", className)}>
      <div 
        className="flex items-center justify-center rounded-xl bg-[var(--accent)]/10 border border-[var(--accent)]"
        style={{ width: s.icon, height: s.icon }}
      >
        <BrandMark style={{ width: s.iconSize, height: s.iconSize }} />
      </div>
      <div className="text-center">
        <h1 className={cn("font-display font-black tracking-tight text-[var(--text-primary)]", s.title)}>
          Let&apos;s Collab!
        </h1>
        <p className={cn("font-mono uppercase tracking-[0.1em] text-[var(--text-dim)]", s.subtitle)}>
